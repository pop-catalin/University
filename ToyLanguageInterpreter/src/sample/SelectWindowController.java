...
public class SelectWindowController {
    ...
    private void populateSelectWindow() {
                        ...
                        new CompoundStatement(
                                new ForkStatement(
                                        new CompoundStatement(
                                                new WriteHeap("a", new ConstExp(30)),
                                                new CompoundStatement(
                                                        new AssignStatement("v", new ConstExp(32)),
                                                        new CompoundStatement(
                                                                new PrintStatement(new VarExp("v")),
                                                                new PrintStatement(new ReadHeap("a")))))),
                                new CompoundStatement(
        ...
        IStatement ex25 = new CompoundStatement(new AssignStatement("v", new ConstExp(10)),
        ...
        */
        ...
        programStatements = new ArrayList<>(Arrays.asList(ex1, ex2, ex3, ex4, ex5, ex6, ex7, ex8, ex9, ex10, ex11, ex12, ex15, ex20, ex14, ex13, ex25));
    }
